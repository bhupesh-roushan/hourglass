  ...
  const editProfileHandler = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://hourglass-0e3w.onrender.com/api/v1/user/profile/edit",
        formData,
        {
          headers: {
  ...
  return (
    <div className="w-full h-screen bg-black">
      <div className="w-full h-full flex items-center justify-center">
        <div className=" flex items-center justify-center   bg-black shadow-md shadow-gray-700 p-5 rounded-md">
          <section className="flex flex-col gap-6 w-full my-8">
            <h1 className="font-bold text-xl text-white">Edit Profile</h1>
            <div className="flex flex-col md:flex-row gap-5 items-center justify-between bg-black text-white rounded-xl p-4">
            ...
            <div>
              ...
              <Textarea
                ...
                name="bio"
                className="focus-visible:ring-transparent bg-black text-white"
              />
            </div>
            <div>
